...
function folderImages(folder, files) {
    return files.map(function(file) {
        ...
        return {
            ...
            full: folderPath + encodeURIComponent(file + ".webp")
        };
    });
}
