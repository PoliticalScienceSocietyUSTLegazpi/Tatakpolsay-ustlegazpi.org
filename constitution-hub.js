const constitutionTopics = [

    {
        ...
        icon: "📜",
        summary: "States the ideals, purposes, and aspirations of the Filipino people in establishing the Constitution.",
        simple: "The Preamble explains why the Constitution was created and the values it seeks to uphold.",
        keyTopics: [
            "Sovereignty",
            "Democracy",
            "Rule of Law",
        ...
        importance: "Although it is not a source of rights or powers, the Preamble serves as the guiding philosophy of the Constitution and helps interpret its provisions.",
    ...
    },
    {
        ...
        icon: "🗺️",
        summary: "Defines the territory of the Philippines, including its land, waters, airspace, and areas under Philippine sovereignty.",
        simple: "This explains what belongs to the Philippines.",
        keyTopics: ["National Territory", "Archipelagic Waters", "Internal Waters", "Airspace", "Sovereignty"],
        importance: "It protects the country’s territorial integrity and helps define the limits of Philippine sovereignty.",
    ...
    },
    {
        ...
        icon: "🏛️",
        summary: "States the fundamental principles and policies that guide the Philippine government.",
        simple: "This explains the values and goals of the State.",
        keyTopics: ["Democracy", "Republicanism", "Civilian Supremacy", "Social Justice", "Peace", "Environment"],
        importance: "It guides government actions, laws, and public policies.",
...
SECTION 28. Subject to reasonable conditions prescribed by law, the State adopts and implements a policy of full public disclosure of all its transactions involving public interest.`
    ...
    },
    {
        ...
        icon: "🛡️",
        summary: "Protects the basic rights and freedoms of every individual.",
        simple: "This protects the rights of the people.",
        keyTopics: ["Due Process", "Equal Protection", "Freedom of Speech", "Freedom of Religion", "Search and Seizure", "Writ of Habeas Corpus"],
        importance: "The Bill of Rights limits government power and protects the freedoms of every citizen.",
...
SECTION 22. No ex post facto law or bill of attainder shall be enacted.`
    ...
    },
    {
        ...
        topic: "Citizenship",
        icon: "👥",
        summary: "Defines who are Filipino citizens and explains citizenship rules.",
        simple: "This explains who is legally recognized as Filipino.",
        keyTopics: ["Natural-born Citizens", "Naturalization", "Dual Citizenship", "Citizenship by Birth"],
        importance: "Citizenship determines political rights such as voting and holding public office.",
...
SECTION 5. Dual allegiance of citizens is inimical to the national interest and shall be dealt with by law.`
    ...
    },
    {
        ...
        topic: "Suffrage",
        icon: "🗳️",
        summary: "Provides the qualifications and requirements for voting.",
        simple: "This explains who can vote.",
        keyTopics: ["Right to Vote", "Qualified Voters", "Registration", "Elections", "COMELEC"],
        importance: "Suffrage allows citizens to participate in democracy by choosing their leaders.",
...
The Congress shall also design a procedure for the disabled and the illiterates to vote without the assistance of other persons. Until then, they shall be allowed to vote under existing laws and such rules as the Commission on Elections may promulgate to protect the secrecy of the ballot.`
    ...
    },
    {
        ...
        icon: "⚖️",
        summary: "Creates the Congress of the Philippines and defines its lawmaking powers.",
        simple: "This explains the branch that makes laws.",
        keyTopics: ["Senate", "House of Representatives", "Lawmaking", "Impeachment", "Appropriations"],
        importance: "Congress represents the people and creates laws for the country.",
...
SECTION 32. The Congress shall, as early as possible, provide for a system of initiative and referendum, and the exceptions therefrom, whereby the people can directly propose and enact laws or approve or reject any act or law or part thereof passed by the Congress or local legislative body after the registration of a petition therefor signed by at least ten per centum of the total number of registered voters, of which every legislative district must be represented by at least three per centum of the registered voters thereof.`
    ...
    },
    {
        ...
        icon: "🎙️",
        summary: "Creates the Executive Branch headed by the President.",
        simple: "This explains the branch that enforces laws.",
        keyTopics: ["President", "Vice President", "Cabinet", "Commander-in-Chief", "Appointments"],
        importance: "The Executive Department implements laws and manages government operations.",
...
SECTION 23. The President shall address the Congress at the opening of its regular session. He may also appear before it at any other time.`
    ...
    },
    {
        ...
        icon: "⚖️",
        summary: "Creates the Supreme Court and the Philippine judicial system.",
        simple: "This explains the courts and justice system.",
        keyTopics: ["Supreme Court", "Judicial Review", "Lower Courts", "Judicial Independence", "Rule of Law"],
        importance: "The Judiciary interprets laws and checks if government actions follow the Constitution.",
...
SECTION 16. The Supreme Court shall, within thirty days from the opening of each regular session of the Congress, submit to the President and the Congress an annual report on the operations and activities of the Judiciary.`
    ...
    },
    {
        ...
        icon: "👥",
        summary: "Creates independent constitutional commissions.",
        simple: "This explains independent government agencies.",
        keyTopics: ["Civil Service Commission", "COMELEC", "Commission on Audit", "Independence"],
        importance: "These commissions promote fair elections, honest public service, and proper use of public funds.",
...
SECTION 4. The Commission shall submit to the President and the Congress, within the time fixed by law, an annual report covering the financial condition and operation of the Government, its subdivisions, agencies, and instrumentalities, including government-owned or controlled corporations, and non-governmental entities subject to its audit, and recommend measures necessary to improve their effectiveness and efficiency. It shall submit such other reports as may be required by law.`
    ...
    },
    {
        ...
        icon: "🏘️",
        summary: "Explains local government units and local autonomy.",
        simple: "This explains provinces, cities, municipalities, and barangays.",
        keyTopics: ["LGUs", "Barangays", "Cities", "Municipalities", "Autonomous Regions"],
        importance: "Local governments are given autonomy to manage their own affairs while remaining under the supervision of the National Government.",
...
SECTION 21. The preservation of peace and order within the regions shall be the responsibility of the local police agencies which shall be organized, maintained, supervised, and utilized in accordance with applicable laws. The defense and security of the regions shall be the responsibility of the National Government.`
    ...
    },
    {
        ...
        icon: "📜",
        summary: "States that public office is a public trust.",
        simple: "This explains that officials must be responsible and honest.",
        keyTopics: ["Public Trust", "Impeachment", "Ombudsman", "SALN", "Integrity"],
        importance: "Public officials are accountable to the people and must serve with honesty, integrity, and responsibility.",

text: `Accountability of Public Officers
...
SECTION 18. Public officers and employees owe the State and this Constitution allegiance at all times, and any public officer or employee who seeks to change his citizenship or acquire the status of an immigrant of another country during his tenure shall be dealt with by law.`
    ...
    },
    {
        ...
        icon: "🌾",
        summary: "Explains rules on the economy, natural resources, and national patrimony.",
        simple: "This explains how national resources should be protected.",
        keyTopics: ["Natural Resources", "Economy", "Public Utilities", "Foreign Investments", "Patrimony"],
        importance: "The Constitution protects the nation's economy and natural resources while promoting Filipino ownership and sustainable development.",
...
SECTION 22. Acts which circumvent or negate any of the provisions of this Article shall be considered inimical to the national interest and subject to criminal and civil sanctions, as may be provided by law.`
    ...
    },
    {
        ...
        icon: "🤝",
        summary: "Promotes social justice and protects human rights.",
        simple: "This explains how the State protects people’s welfare.",
        keyTopics: ["Human Rights", "Labor", "Agrarian Reform", "Urban Poor", "Health", "Women"],
        importance: "It protects vulnerable sectors and promotes fairness in society.",
...
SECTION 19. The Congress may provide for other cases of violations of human rights that should fall within the authority of the Commission, taking into account its recommendations.`
    ...
    {
        title: "Article XIV",
        topic: "Education, Science and Technology, Arts, Culture, and Sports",
        icon: "🎓",
        summary: "Explains the State’s duties in education, culture, science, and sports.",
        simple: "This explains the importance of learning and culture.",
        keyTopics: ["Education", "Academic Freedom", "Science", "Technology", "Culture", "Sports"],
        importance: "Education and culture help build responsible citizens and national development.",
...
(2) All educational institutions shall undertake regular sports activities throughout the country in cooperation with athletic clubs and other sectors.`
    ...
    },
    {
        ...
        topic: "The Family",
        icon: "👨‍👩‍👧",
        summary: "Recognizes the Filipino family as the foundation of the nation.",
        simple: "This explains the protection given to families.",
        keyTopics: ["Family", "Marriage", "Parents", "Children", "Youth"],
        importance: "Strong families help build a stable and caring society.",
...
SECTION 4. The family has the duty to care for its elderly members but the State may also do so through just programs of social security.`
    ...
    },
    {
        ...
        icon: "🇵🇭",
        summary: "Contains other important constitutional rules.",
        simple: "This explains additional national rules.",
        keyTopics: ["National Flag", "Armed Forces", "Police", "Mass Media", "Public Service"],
        importance: "These provisions protect national identity, public service, consumers, veterans, and the armed forces.",
...
SECTION 12. The Congress may create a consultative body to advise the President on policies affecting indigenous cultural communities, the majority of the members of which shall come from such communities.`
    ...
    {
        title: "Article XVII",
        topic: "Amendments or Revisions",
        icon: "✍️",
        summary: "Explains how the Constitution may be changed.",
        simple: "This explains how constitutional changes can happen.",
        keyTopics: ["Constitutional Convention", "Constituent Assembly", "People’s Initiative", "Ratification"],
        importance: "The Constitution provides legal ways to amend or revise its provisions.",
...
Any amendment under Section 2 hereof shall be valid when ratified by a majority of the votes cast in a plebiscite which shall be held not earlier than sixty days nor later than ninety days after the certification by the Commission on Elections of the sufficiency of the petition.`
    ...
    {
        title: "Article XVIII",
        topic: "Transitory Provisions",
        icon: "🔄",
        summary: "Provides temporary rules for the shift to the 1987 Constitution.",
        simple: "This explains temporary rules when the Constitution started.",
        keyTopics: ["Transition", "Existing Laws", "Reorganization", "Continuity", "Implementation"],
        importance: "It helped the government transition smoothly under the 1987 Constitution.",

text: `SECTION 1. The first elections of Members of the Congress under this Constitution shall be held on the second Monday of May, 1987.
...
const constitutionContainer = document.getElementById("constitutionContainer");
const constitutionSearch = document.getElementById("constitutionSearch");

function displayConstitutionTopics() {
    const searchText = constitutionSearch.value.toLowerCase();

    const filteredTopics = constitutionTopics.filter(item =>
        ...
        item.keyTopics.join(" ").toLowerCase().includes(searchText)
    );

    constitutionContainer.classList.add("constitution-grid");

    constitutionContainer.innerHTML = filteredTopics.map(item => `
        <div class="constitution-card">
            <div class="constitution-icon">${item.icon}</div>

            <span class="constitution-badge">${item.title}</span>

            <h3>${item.topic}</h3>

            <p>${item.summary}</p>

            <button class="constitution-view-btn" onclick="openConstitutionModal('${item.title}')">
...
function formatConstitutionText(text) {
    return text
        ...
        .replace(
            /^(A\. Common Provisions|B\. The Civil Service Commission|C\. The Commission on Elections|D\. Commission on Audit|Principles|State Policies|General Provisions|Autonomous Region|Labor|Agrarian and Natural Resources Reform|Urban Land Reform and Housing|Health|Women|Role and Rights of People’s Organizations|Human Rights|Education|Language|Science and Technology|Arts and Culture|Sports|Accountability of Public Officers)$/gm,
            "<strong>$1</strong>"
        );
}

function openConstitutionModal(title) {
    const item = constitutionTopics.find(article => article.title === title);

    document.body.insertAdjacentHTML("beforeend", `
        <div class="constitution-modal active" id="constitutionModal">
            <div class="constitution-modal-box">
                <button class="constitution-close-btn" onclick="closeConstitutionModal()">×</button>
                ...
                <h4>📚 Key Topics</h4>
                <ul>
                    ${item.keyTopics.map(topic => `<li>${topic}</li>`).join("")}
                </ul>
...
${item.text ? `
    ...
    <div class="constitution-preamble">
    ${formatConstitutionText(item.text)}
</div>
` : ""}
            </div>
        </div>
...
constitutionSearch.addEventListener("input", displayConstitutionTopics);

displayConstitutionTopics();